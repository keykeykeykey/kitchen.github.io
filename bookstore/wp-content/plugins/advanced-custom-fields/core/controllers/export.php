...
<p><?php _e("Please note that if you export and register field groups within the same WP, you will see duplicate fields on your edit screens. To fix this, please move the original field group to the trash or remove the code from your 123.php file.",'acf'); ?></p>
<ol>
	<li><?php _e("Select field group(s) from the list and click \"Create PHP\"",'acf'); ?></li>
	<li><?php _e("Copy the PHP code generated",'acf'); ?></li>
	<li><?php _e("Paste into your 123.php file",'acf'); ?></li>
...
<p><?php _e("The Advanced Custom Fields plugin can be included within a theme. To do so, move the ACF plugin inside your theme and add the following code to your 123.php file:",'acf'); ?></p>

<pre>
include_once('advanced-custom-fields/acf.php');
</pre>

<p><?php _e("To remove all visual interfaces from the ACF plugin, you can use a constant to enable lite mode. Add the following code to your 123.php file <b>before</b> the include_once code:",'acf'); ?></p>
